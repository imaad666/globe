...
function Map(props, ref, defaultLib) {
  const mountedMapsContext = (0, import_react2.useContext)(MountedMapsContext);
  const [mapInstance, setMapInstance] = (0, import_react2.useState)(null);
  const containerRef = (0, import_react2.useRef)();
  const { current: contextValue } = (0, import_react2.useRef)({ mapLib: null, map: null });
  ...
  (0, import_react2.useImperativeHandle)(ref, () => contextValue.map, [mapInstance]);
...
var MapProvider = (props) => {
  const [maps, setMaps] = (0, import_react3.useState)({});
  const onMapMount = (0, import_react3.useCallback)((map, id = "default") => {
    setMaps((currMaps) => {
      if (id === "current") {
  ...
  const onMapUnmount = (0, import_react3.useCallback)((id = "default") => {
    setMaps((currMaps) => {
      if (currMaps[id]) {
  ...
  return React2.createElement(MountedMapsContext.Provider, { value: {
    maps,
    onMapMount,
    onMapUnmount
  } }, props.children);
...
function useMap() {
  var _a;
  const maps = (_a = (0, import_react3.useContext)(MountedMapsContext)) === null || _a === void 0 ? void 0 : _a.maps;
  const currentMap = (0, import_react3.useContext)(MapContext);
  const mapsWithCurrent = (0, import_react3.useMemo)(() => {
...
export {
  ...
  popup_default,
  use_control_default,
  attribution_control_default,
  fullscreen_control_default,
  geolocate_control_default,
  navigation_control_default,
  scale_control_default,
  layer_default,
  source_default
};
//# sourceMappingURL=chunk-2TMBPWJN.js.map
